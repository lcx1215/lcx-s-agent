...
const FAILURE_CASE_RECIPES: FailureCaseRecipe[] = [
  ...
  },
  {
    ...
    priority: 109,
    userMessage:
      "训练本地大脑把网上学习内化链条推广到所有模块，不只因子模块。每个目标模块都必须有 source registry、actual reading scope、模块专属能力规则、retrieval receipt、apply validation、eval/training absorption、fresh adjacent task、安全边界和 keep/downrank/discard；不能把存档说成模块学会。",
    sourceSummary:
