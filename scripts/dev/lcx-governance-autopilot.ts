...
function buildContextRecoveryHandoff({
  ...
  return [
    ...
    "- boundary: dev_skillopt_lite_only; immediate preflight is SOP context, not model-weight absorption or user-visible proof",
    "",
    "## Self-Repair Hands",
    ...
    "- boundary: dev_monotonic_data_ledger_only; data growth is not model absorption or user-visible proof",
    "",
