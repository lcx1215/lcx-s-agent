...
if [[ -z "$version_content" ]]; then
  echo "<h2>LCX Agent $VERSION</h2>"
  echo "<p>Latest LCX Agent update.</p>"
  echo "<p><a href=\"https://github.com/lcx1215/lcx-s-agent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
