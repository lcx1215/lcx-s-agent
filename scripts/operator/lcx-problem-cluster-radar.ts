...
function usage(): never {
  throw new Error(
    [
      "Usage: node --import tsx scripts/operator/lcx-problem-cluster-radar.ts [--json]",
      "",
...
function architectureSupervisionCluster(inputs: RadarInputs): ProblemCluster | undefined {
  ...
  return problemCluster({
    ...
    ownerEntrypoint: "scripts/operator/lcx-mind-model.ts + scripts/operator/lcx-flow-graph.ts",
...
function learningSedimentationCluster(inputs: RadarInputs): ProblemCluster | undefined {
  ...
  return problemCluster({
    ...
    ownerEntrypoint:
      "scripts/operator/lcx-learning-sedimentation-audit.ts + scripts/operator/lcx-learning-sedimentation-map.ts",
...
function systemMemoryCluster(inputs: RadarInputs): ProblemCluster | undefined {
  ...
  return problemCluster({
    ...
    ownerEntrypoint: "scripts/operator/lcx-system-memory-sedimentation-gate.ts",
...
function dirtyWorktreeCluster(inputs: RadarInputs): ProblemCluster | undefined {
  ...
  return problemCluster({
    ...
    ownerEntrypoint: "scripts/operator/lcx-change-impact-plan.ts",
