...
const ENGINEERING_MICRO_CONTRACTS: CriticalModuleContract[] = [
  ...
  {
    id: "core_external_channel_boundary",
    headTerms: ["core-verified", "user-visible-observed"],
  ...
  },
  {
    ...
    tailTerms: [
      ...
      "globalEvidenceProjectionReadStatus",
    ],
  },
  {
...
function usage(): never {
  throw new Error(
    [
      "Usage: node --import tsx scripts/operator/lcx-head-tail-consistency.ts [--json]",
      "",
