...
const PATH_RULES: PathRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/operator\/external-channel-sidecar-(?:scheduler-dry-run|host-watchdog-dry-run|feishu-proxy-preflight|install-preflight|install-dry-run|install-smoke|launchagent-plan)\.ts$/u,
      /^test\/lcx-external-channel-compat-status\.test\.ts$/u,
      /^test\/external-channel-sidecar-[^/]+\.test\.ts$/u,
      /^ops\/external-channel-artifacts\/launchagent-candidates\//u,
