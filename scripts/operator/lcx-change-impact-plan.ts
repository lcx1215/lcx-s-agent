...
const PATH_RULES: PathRule[] = [
  {
    ...
    patterns: [
      ...
      /^test\/dev\//u,
      /^ops\/live-handoff\//u,
      /^ops\/dev-to-live-feishu-acceptance-runbook\.md$/u,
      /^vitest\.scripts-dev\.config\.ts$/u,
      /^(?:scripts\/dev|test\/dev|ops\/live-handoff|ops\/dev-to-live-feishu-acceptance-runbook)[^>]* -> .+$/u,
      /^(?:scripts\/operator|test\/operator|ops\/external-channel-(?:history|artifacts))\/$/u,
    ],
    requiredChecks: ["physical-path-scan", "git-diff-check"],
    commands: [
      "rg -n --hidden --glob '!.git/**' --glob '!node_modules/**' '(scripts/dev|test/dev|ops/live-handoff|dev-to-live-feishu-acceptance-runbook)' .",
      "git diff --check",
    ],
    safetyNotes: [
  ...
  },
  {
    ...
    patterns: [
      ...
      /^ops\/external-channel-feishu-acceptance-runbook\.md$/u,
  ...
  },
  {
    ...
    commands: [
      ...
      "pnpm vitest run test/lcx-change-impact-plan.test.ts test/lcx-flow-graph.test.ts test/lcx-mind-model.test.ts test/lcx-context-recovery-exam.test.ts test/lcx-agent-exam.test.ts test/lcx-problem-cluster-radar.test.ts test/lcx-commercial-acceptance-harness.test.ts test/lcx-governance-autopilot.test.ts test/lcx-external-agent-upgrade-radar.test.ts test/lcx-live-fadeout-audit.test.ts test/lcx-skillopt-lite.test.ts test/lcx-provider-council-acceleration.test.ts test/lcx-ts-python-boundary.test.ts test/lcx-universe-index.test.ts test/lcx-multi-agent-pattern-shadow.test.ts",
    ],
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/operator\/lark-brain-distillation-/u,
  ...
  },
  {
    ...
    patterns: [
      ...
      /^scripts\/operator\/lcx-lark-short-intent-fuzzer\.ts$/u,
      /^scripts\/operator\/lark-adversarial-workflow-smoke\.ts$/u,
