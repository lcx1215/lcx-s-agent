...
function usage(): never {
  throw new Error(
    "Usage: node --import tsx scripts/operator/lark-brain-distillation-teacher-batch.ts [--workspace DIR] [--write] [--json]",
  );
}
...
const CASES: TeacherCase[] = [
  ...
  },
  {
    ...
    payload:
      "This is an ops audit, not a finance research task. Select ops_audit and request visible reply or message id before claiming user-visible-observed.",
