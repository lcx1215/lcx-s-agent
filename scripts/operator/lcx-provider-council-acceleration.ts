...
function usage(): never {
  throw new Error(
    [
      "Usage: node --import tsx scripts/operator/lcx-provider-council-acceleration.ts [--write] [--json]",
...
async function main() {
  ...
  const details = {
    ...
    providerRunTimedOut,
    nextSafeCommand:
      "node --import tsx scripts/operator/lcx-provider-council-acceleration.ts --write --json --profile aggressive",
    outputsFeed: [
