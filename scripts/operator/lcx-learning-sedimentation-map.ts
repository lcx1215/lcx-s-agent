...
function usage(): never {
  throw new Error(
    [
      ...
      "This is read-only local evidence and never writes memory, changes external-channel state, changes providers, or promotes adapters.",
    ].join("\n"),
  );
}
  ...
  const lanes: SedimentationLane[] = [
    ...
    },
    {
      ...
      doesNotProve: [
        ...
        "It is not user-visible-observed proof.",
      ],
    ...
    },
    {
      ...
      doesNotProve: [
        "It does not prove user-visible-observed.",
