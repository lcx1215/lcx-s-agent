...
- Keep product names in English: LCX Agent, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the LCX Agent Gateway, use “Gateway 网关”.
