...
show_usage() {
    cat << EOF
clawlog - LCX Agent Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View LCX Agent logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    LCX Agent logs flow through the macOS unified log (subsystem: ai.openclaw).
