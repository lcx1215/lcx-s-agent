...
```text
ops/external-channel-artifacts/launchagent-candidates/ai.openclaw.lobster.scheduler.smoke.plist
ops/external-channel-artifacts/launchagent-candidates/ai.openclaw.lobster.host_watchdog.smoke.plist
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-launchagent-plan.json
```
...
```text
plutil -lint ops/external-channel-artifacts/launchagent-candidates/*.plist
status: OK
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-install-dry-run-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-install-smoke-rollback-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-install-smoke-receipt.json
...
OPENCLAW_SCHEDULER_CYCLE_COMMAND=pnpm exec tsx scripts/operator/agent-system-loop-smoke.ts
scheduler.runs=1
scheduler.last_exit_code=0
...
```text
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-scheduler-cycle-install-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-feishu-proxy-preflight-receipt.json
ops/external-channel-artifacts/launchagent-candidates/external-channel-sidecar-feishu-proxy-install-receipt.json
```
