...
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-launchagent-plan.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-install-dry-run-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-install-smoke-rollback-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-install-smoke-receipt.json
...
```text
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-scheduler-cycle-install-receipt.json
```
...
```text
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-feishu-proxy-preflight-receipt.json
ops/external-channel-artifacts/launchagent-candidates/live-sidecar-feishu-proxy-install-receipt.json
```
