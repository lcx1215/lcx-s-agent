---
summary: "Use NVIDIA's OpenAI-compatible API in LCX Agent"
read_when:
  - You want to use NVIDIA models in LCX Agent
...
lcx onboard --auth-choice skip
lcx models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
