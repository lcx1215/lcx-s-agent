...
You can point LCX Agent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or LCX Agent
...
- [Anthropic provider](/providers/anthropic) - Native LCX Agent integration with Claude setup-token or API keys
