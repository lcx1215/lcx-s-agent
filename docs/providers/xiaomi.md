---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with LCX Agent"
read_when:
  - You want Xiaomi MiMo models in LCX Agent
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). LCX Agent uses
