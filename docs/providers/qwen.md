---
summary: "Use Qwen OAuth (free tier) in LCX Agent"
read_when:
  - You want to use Qwen with LCX Agent
...
If you already logged in with the Qwen Code CLI, LCX Agent will sync credentials
