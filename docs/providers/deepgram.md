...
Deepgram is a speech-to-text API. In LCX Agent it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, LCX Agent uploads the audio file to Deepgram and injects the transcript
