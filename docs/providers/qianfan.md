---
summary: "Use Qianfan's unified API to access many models in LCX Agent"
read_when:
...
3. LCX Agent installed on your system
...
4. Copy the API key for use with LCX Agent

## CLI setup

```bash
lcx onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [LCX Agent Configuration](/gateway/configuration)
