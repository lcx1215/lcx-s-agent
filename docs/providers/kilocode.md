---
summary: "Use Kilo Gateway's unified API to access many models in LCX Agent"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in LCX Agent
---
...
```bash
lcx onboard --kilocode-api-key <key>
```
