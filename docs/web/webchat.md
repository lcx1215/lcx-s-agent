...
Status: the WebChat UI talks directly to the Gateway WebSocket.

## What it is

- A chat UI for the gateway that talks to the Gateway WebSocket directly (no separate WebChat server).
...
1. Start the gateway.
2. Open the WebChat UI or the Control UI chat tab in a browser.
