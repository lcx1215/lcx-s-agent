---
summary: "LCX Agent Gateway CLI (`lcx gateway`) — run, query, and discover gateways"
read_when:
...
The Gateway is LCX Agent’s WebSocket server (channels, nodes, sessions, hooks).

Subcommands in this page live under `lcx gateway …`.
