---
summary: "LCX Agent on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up LCX Agent on DigitalOcean
  - Looking for cheap VPS hosting for LCX Agent
title: "DigitalOcean"
---

# LCX Agent on DigitalOcean

## Goal

Run a persistent LCX Agent Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# Check service
systemctl --user status lcx-gateway.service

# View logs
journalctl --user -u lcx-gateway.service -f
```
