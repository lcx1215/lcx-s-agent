...
LCX Agent ships three update channels:
...
When you **explicitly** switch channels with `--channel`, LCX Agent also aligns
the install method:
...
When you switch channels with `lcx update`, LCX Agent also syncs plugin sources:
