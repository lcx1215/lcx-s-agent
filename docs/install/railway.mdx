...
Deploy LCX Agent on Railway with a one-click template and finish setup in your browser.
...
This exports your LCX Agent state + workspace so you can migrate to another host without losing config or memory.
