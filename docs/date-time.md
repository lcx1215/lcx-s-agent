...
LCX Agent defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, LCX Agent inspects the OS preference (macOS/Windows)
