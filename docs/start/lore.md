---
summary: "Backstory and lore of LCX Agent for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "LCX Agent Lore"
---

# The Lore of LCX Agent 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **LCX Agent**.
...
In the end, **LCX Agent** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around LCX Agent. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then LCX Agent): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "lcx what did we discuss about talking with people xD"
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at LCX Agent" to promote pump-and-dump tokens.
...
**The Great LCX Agent Migration** began.
