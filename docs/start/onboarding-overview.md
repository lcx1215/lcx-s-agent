---
summary: "Overview of LCX Agent onboarding options and flows"
read_when:
...
LCX Agent supports multiple onboarding paths depending on where the Gateway runs
...
- [`lcx onboard` command](/cli/onboard)
