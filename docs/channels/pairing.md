...
read_when:
  ...
  - Reviewing LCX Agent security posture
title: "Pairing"
---

# Pairing

“Pairing” is LCX Agent’s explicit **owner approval** step.
...
Supported channels: `telegram`, `whatsapp`, `signal`, `imessage`, `discord`, `slack`, `external`.
...
3. On your phone, open the LCX Agent client → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `lcx nodes pending/approve`) is a
