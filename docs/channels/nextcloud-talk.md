...
```bash
lcx plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "LCX Agent" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `lcx pairing list nextcloud-talk`
  - `lcx pairing approve nextcloud-talk <CODE>`
