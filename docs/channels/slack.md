...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure LCX Agent HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `lcx pairing approve slack <code>`.
...
LCX Agent supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, LCX Agent falls back to normal delivery for remaining payloads.
