...
vi.mock("lcx-agent/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("lcx-agent/plugin-sdk/whatsapp")>(
    "lcx-agent/plugin-sdk/whatsapp",
  );
