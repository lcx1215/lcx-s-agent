...
import type { DiagnosticEventPayload, OpenClawPluginService } from "lcx-agent/plugin-sdk";
import { onDiagnosticEvent, redactSensitiveText, registerLogTransport } from "lcx-agent/plugin-sdk";
