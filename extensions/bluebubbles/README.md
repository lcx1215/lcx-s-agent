...
This directory contains the **BlueBubbles external channel plugin** for LCX Agent.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `lcx-agent/plugin-sdk` helpers.
