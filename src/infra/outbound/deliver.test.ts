...
describe("deliverOutboundPayloads", () => {
  ...
  it("includes LCX Agent tmp root in telegram mediaLocalRoots", async () => {
    const sendTelegram = vi.fn().mockResolvedValue({ messageId: "m1", chatId: "c1" });
  ...
  it("includes LCX Agent tmp root in signal mediaLocalRoots", async () => {
  ...
  it("includes LCX Agent tmp root in whatsapp mediaLocalRoots", async () => {
    const sendWhatsApp = vi.fn().mockResolvedValue({ messageId: "w1", toJid: "jid" });
  ...
  it("includes LCX Agent tmp root in imessage mediaLocalRoots", async () => {
