...
export async function installChromeExtension(opts?: {
  ...
  if (!hasManifest(src)) {
    throw new Error("Bundled Chrome extension is missing. Reinstall LCX Agent and try again.");
  }
      ...
      defaultRuntime.error(
        info(
          [
            ...
            `- Pin “LCX Agent Browser Relay”, then click it on the tab (badge shows ON)`,
            "",
