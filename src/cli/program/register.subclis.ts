...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live LCX Agent docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage LCX Agent plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Update LCX Agent and inspect update channel status",
    hasSubcommands: true,
    register: async (program) => {
