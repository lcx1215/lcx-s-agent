...
export async function finalizeOnboardingWizard(
    ...
    if (hatchChoice === "tui") {
      ...
      await prompter.note(
        [
          ...
          controlUiOpened
            ? "Opened in your browser. Keep that tab to control LCX Agent."
            : "Copy/paste this URL in a browser on this machine to control LCX Agent.",
          controlUiOpenHint,
        ]
          .filter(Boolean)
          .join("\n"),
  ...
  await prompter.note(
    hasWebSearchKey
      ...
      : [
          ...
          "",
          "LCX Agent uses Brave Search for the `web_search` tool. Without a Brave Search API key, web search won’t work.",
          "",
  ...
  await prompter.note(
    `What now: ${CANONICAL_PROJECT_URL} — docs, issues and releases.`,
    "What now",
  );

  await prompter.outro(
    controlUiOpened
      ? "Onboarding complete. Dashboard opened; keep that tab to control LCX Agent."
      : seededInBackground
        ? "Onboarding complete. Web UI seeded in the background; open it anytime with the dashboard link above."
        : "Onboarding complete. Use the dashboard link above to control LCX Agent.",
  );
