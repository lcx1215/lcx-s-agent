...
const SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.external.accounts.*.inboundToken",
    targetType: "channels.external.accounts.*.inboundToken",
    configFile: "openclaw.json",
    pathPattern: "channels.external.accounts.*.inboundToken",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.external.accounts.*.outboundToken",
    targetType: "channels.external.accounts.*.outboundToken",
    configFile: "openclaw.json",
    pathPattern: "channels.external.accounts.*.outboundToken",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.external.inboundToken",
    targetType: "channels.external.inboundToken",
    configFile: "openclaw.json",
    pathPattern: "channels.external.inboundToken",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.external.outboundToken",
    targetType: "channels.external.outboundToken",
    configFile: "openclaw.json",
    pathPattern: "channels.external.outboundToken",
    secretShape: "secret_input",
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
