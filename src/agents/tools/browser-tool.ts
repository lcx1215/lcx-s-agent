...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    name: "browser",
    description: [
      "Control the browser via LCX Agent's browser control server (status/start/stop/profiles/tabs/open/snapshot/screenshot/actions).",
      ...
      "Chrome extension relay needs an attached tab: user must click the LCX Agent Browser Relay toolbar icon on the tab (badge ON). If no tab is connected, ask them to attach it.",
