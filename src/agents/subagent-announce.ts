    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            '`agents_list` and `subagents` apply to LCX Agent sub-agents (`runtime: "subagent"`); ACP harness ids are controlled by `acp.allowedAgents`.',
            ...
            'Use `subagents` only for LCX Agent subagents (`runtime: "subagent"`).',
