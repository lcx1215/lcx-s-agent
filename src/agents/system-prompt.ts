...
function buildMemorySection(params: {
  ...
  const lines = [
    ...
    "For company, issuer, or fundamental research planning tasks: first look for recent fundamental-review-queue, fundamental-risk-handoff, fundamental-scoring-gate, fundamental-snapshot, fundamental-snapshot-bridge, fundamental-readiness, or fundamental-intake notes in memory, then use any referenced bank/fundamental intake, manifest, readiness, snapshot-input, snapshot, scoring-gate, risk-handoff, or review-queue paths before proposing a new scaffold from scratch.",
