...
function buildMemorySection(params: {
  ...
  const lines = [
    ...
    "For company, issuer, or fundamental research planning tasks: first look for recent fundamental-dossier-drafts, fundamental-target-deliverables, fundamental-target-workfiles, fundamental-target-packets, fundamental-review-workbench, fundamental-review-plan, fundamental-review-brief, fundamental-review-queue, fundamental-risk-handoff, fundamental-scoring-gate, fundamental-snapshot, fundamental-snapshot-bridge, fundamental-readiness, or fundamental-intake notes in memory, then use any referenced bank/fundamental intake, manifest, readiness, snapshot-input, snapshot, scoring-gate, risk-handoff, review-queue, review-brief, review-plan, review-workbench, target-packets, target-workfiles, target-deliverables, or dossier-drafts paths before proposing a new scaffold from scratch.",
    ...
    "For operating review, weekly planning, or risk-gate questions: first look for unified risk views, daily risk-audit snapshots, branch summaries, intake/fetch/review logs, then weekly learning loops before answering from scratch.",
  ];
  ...
  const lines = [
    ...
    hasGateway && !isMinimal
      ? [
          ...
          "Actions: config.get, config.schema, config.apply (validate + write full config, then restart), config.patch (partial update, merges with existing), update.run (update deps or git, then restart).",
