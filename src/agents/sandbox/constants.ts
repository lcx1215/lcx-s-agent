...
export const DEFAULT_SANDBOX_IMAGE = "lcx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "lcx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "lcx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "lcx-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "lcx-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "lcx-sandbox-browser";
