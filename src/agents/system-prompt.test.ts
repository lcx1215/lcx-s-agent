...
describe("buildAgentSystemPrompt", () => {
  ...
  it("adds math and study memory recall guidance when memory tools are available", () => {
    ...
    expect(prompt).toContain(
      "For company, issuer, or fundamental research planning tasks: first look for recent fundamental-risk-handoff, fundamental-scoring-gate, fundamental-snapshot, fundamental-snapshot-bridge, fundamental-readiness, or fundamental-intake notes in memory",
    );
    expect(prompt).toContain(
