...
export type ExternalApiReplyOutputKind =
  | "zh_text"
  | "en_text"
  | "mixed_text"
  | "code"
...
export type ExternalApiReplyRoutingDisposition =
...
export type ExternalApiReplyDistillationSample = {
  outputKind: ExternalApiReplyOutputKind;
  disposition: ExternalApiReplyRoutingDisposition;
  byteLength: number;
  contentHash: string;
...
function classifyText(value: string): ExternalApiReplyOutputKind {
...
function dispositionForKind(kind: ExternalApiReplyOutputKind): ExternalApiReplyRoutingDisposition {
  if (kind === "empty") {
...
function discardReasonForKind(kind: ExternalApiReplyOutputKind): string | undefined {
  if (kind === "empty") {
...
export function normalizeExternalApiReplyForDistillation(
  payload: unknown,
): ExternalApiReplyDistillationSample {
