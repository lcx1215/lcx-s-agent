...
| `local-agent-skill-distiller`     | `skills/local-agent-skill-distiller`     | `https://docs.openhands.dev/overview/skills` and `https://huggingface.co/docs/hub/en/agents-skills`                                                          | Converts local or external skill patterns into LCX-safe skills plus local-brain training/eval packets.         | `rm -rf skills/local-agent-skill-distiller`     |
